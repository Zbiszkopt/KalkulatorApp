...
public class zlecenie extends AppCompatActivity {
    ...
    public void oblicz(View v) {
        ...
        double koszty = (gross - emer - ren) * 0.2;
        double taxPodst = round(gross - emer - ren - koszty);
        double tax = round(taxPodst * 0.12);
